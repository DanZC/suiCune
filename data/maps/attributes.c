...
#define calc_map_len_v(_name, _x) ((_name##_WIDTH + 3 - (_x) > _name##_WIDTH)? _name##_WIDTH: _name##_WIDTH + 3 - (_x))
#define calc_map_len_h(_name, _x) ((_name##_HEIGHT + 3 - (_x) > _name##_HEIGHT)? _name##_HEIGHT: _name##_HEIGHT + 3 - (_x))
#define connection_north(name, name2, x) [NORTH_F] = &(struct MapConnectionData){.connectedMapGroup=GROUP_##name2,\
    ...
    .connectionStripLength = calc_map_len_v(name2, x) - calc_tile_src(x), \
...
#define connection_west(name, name2, x) [WEST_F] = &(struct MapConnectionData){.connectedMapGroup=GROUP_##name2,\
    ...
    .connectionStripLength = calc_map_len_h(name2, x) - calc_tile_src(x), \
    .connectedMapLength = name2##_WIDTH, \
