...
#define roam_map_el(_0) {MAP_ID(_0)}
#define roam_map_list(...) CPPX_INVOKE( CPPX_CONCAT ( roam_map_, PP_NARG(__VA_ARGS__) ) , (__VA_ARGS__) )
#define roam_map_1(_0) roam_map_el(_0)
#define roam_map_2(_0, _1) roam_map_el(_0), roam_map_1(_1)
#define roam_map_3(_0, _1, _2) roam_map_el(_0), roam_map_2(_1, _2)
#define roam_map_4(_0, _1, _2, _3) roam_map_el(_0), roam_map_3(_1, _2, _3)
#define roam_map(_start, ...) {roam_map_el(_start), PP_NARG(__VA_ARGS__), (struct MapId[]){roam_map_list(__VA_ARGS__)}}

const struct RoamMap RoamMaps[] = {
	// list_start RoamMaps
...
static_assert(lengthof(RoamMaps) == NUM_ROAMMON_MAPS, "");
	// db -1 ; end
