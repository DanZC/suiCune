#include "../../constants.h"
const struct TextCmd NurseMornText[] = {
...
const struct TextCmd NurseDayText[] = {
    text_start("Hello!"
        t_line "Welcome to our"
        t_cont "#MON CENTER."
        t_done )
...
const struct TextCmd NurseNiteText[] = {
...
const struct TextCmd PokeComNurseMornText[] = {
    text_start("Good morning!"
...
const struct TextCmd PokeComNurseDayText[] = {
    text_start("Hello!"
...
const struct TextCmd PokeComNurseNiteText[] = {
...
const struct TextCmd NurseAskHealText[] = {
...
const struct TextCmd NurseTakePokemonText[] = {
...
const struct TextCmd NurseReturnPokemonText[] = {
...
const struct TextCmd NurseGoodbyeText[] = {
...
const struct TextCmd NursePokerusText[] = {
    text_start("Your #MON"
        t_line "appear to be"
...
const struct TextCmd PokeComNursePokerusText[] = {
    text_start("Your #MON"
        t_line "appear to be"
...
const struct TextCmd DifficultBookshelfText[] = {
...
const struct TextCmd PictureBookshelfText[] = {
...
const struct TextCmd MagazineBookshelfText[] = {
...
const struct TextCmd TeamRocketOathText[] = {
...
const struct TextCmd IncenseBurnerText[] = {
...
const struct TextCmd MerchandiseShelfText[] = {
...
const struct TextCmd LookTownMapText[] = {
    text_start("It's the TOWN MAP."
        t_done )

};

const struct TextCmd WindowText[] = {
...
const struct TextCmd TVText[] = {
    text_start("It's a TV."
        t_done )

};

const struct TextCmd HomepageText[] = {
...
const struct TextCmd TrashCanText[] = {
...
const struct TextCmd PokecenterSignText[] = {
...
const struct TextCmd MartSignText[] = {
...
const struct TextCmd ContestResults_ReadyToJudgeText[] = {
...
const struct TextCmd ContestResults_PlayerWonAPrizeText[] = {
...
const struct TextCmd ContestResults_JoinUsNextTimeText[] = {
...
const struct TextCmd ContestResults_ConsolationPrizeText[] = {
...
const struct TextCmd ContestResults_DidNotWinText[] = {
...
const struct TextCmd ContestResults_ReturnPartyText[] = {
...
const struct TextCmd ContestResults_PartyFullText[] = {
...
const struct TextCmd GymStatue_CityGymText[] = {
    text_ram(wram_ptr(wStringBuffer3))
    text_start(
        t_line "#MON GYM"
        t_done )
...
const struct TextCmd GymStatue_WinningTrainersText[] = {
    text_start("LEADER: @"
        )
    text_ram(wram_ptr(wStringBuffer4))
    text_start(
...
const struct TextCmd CoinVendor_WelcomeText[] = {
...
const struct TextCmd CoinVendor_NoCoinCaseText[] = {
...
const struct TextCmd CoinVendor_IntroText[] = {
...
const struct TextCmd CoinVendor_Buy50CoinsText[] = {
...
const struct TextCmd CoinVendor_Buy500CoinsText[] = {
...
const struct TextCmd CoinVendor_NotEnoughMoneyText[] = {
...
const struct TextCmd CoinVendor_CoinCaseFullText[] = {
...
const struct TextCmd CoinVendor_CancelText[] = {
...
const struct TextCmd BugContestPrizeNoRoomText[] = {
...
const struct TextCmd HappinessText3[] = {
...
const struct TextCmd HappinessText2[] = {
...
const struct TextCmd HappinessText1[] = {
...
const struct TextCmd RegisteredNumber1Text[] = {
...
const struct TextCmd RegisteredNumber2Text[] = {
    text_start("<PLAYER> registered"
        t_line "@"
        )
    text_ram(wram_ptr(wStringBuffer3))
