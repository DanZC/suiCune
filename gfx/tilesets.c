...
const char TilesetPortMeta[] = "data/tilesets/port_metatiles.bin.png";
...
const char TilesetPlayersHouseMeta[] = "data/tilesets/players_house_metatiles.bin.png";
...
const char TilesetMansionMeta[] = "data/tilesets/mansion_metatiles.bin.png";
...
const char TilesetCaveMeta[] = "data/tilesets/cave_metatiles.bin.png";
...
const char TilesetGameCornerMeta[] = "data/tilesets/game_corner_metatiles.bin.png";
...
const char TilesetTrainStationMeta[] = "data/tilesets/train_station_metatiles.bin.png";
const uint8_t TilesetTrainStationColl[] = {
// #include "data/tilesets/train_station_collision.h"
};
const char TilesetForestMeta[] = "data/tilesets/forest_metatiles.bin.png";


// SECTION "Tileset Data 4", ROMX

const char TilesetEliteFourRoomGFX[] = "gfx/tilesets/elite_four_room.png";
const char TilesetEliteFourRoomMeta[] = "data/tilesets/elite_four_room_metatiles.bin.png";
...
const char TilesetParkMeta[] = "data/tilesets/park_metatiles.bin.png";
...
const char TilesetRadioTowerMeta[] = "data/tilesets/radio_tower_metatiles.bin.png";
...
const char TilesetUndergroundMeta[] = "data/tilesets/underground_metatiles.bin.png";
...
const char TilesetBattleTowerInsideMeta[] = "data/tilesets/battle_tower_inside_metatiles.bin.png";
...
const char TilesetGateMeta[] = "data/tilesets/gate_metatiles.bin.png";
...
const char TilesetJohtoModernMeta[] = "data/tilesets/johto_modern_metatiles.bin.png";
...
const char TilesetTraditionalHouseMeta[] = "data/tilesets/traditional_house_metatiles.bin.png";
...
const char TilesetChampionsRoomMeta[] = "data/tilesets/champions_room_metatiles.bin.png";
...
const char TilesetHouseMeta[] = "data/tilesets/house_metatiles.bin.png";
...
const char TilesetLighthouseMeta[] = "data/tilesets/lighthouse_metatiles.bin.png";
...
const char TilesetFacilityMeta[] = "data/tilesets/facility_metatiles.bin.png";
const uint8_t TilesetFacilityColl[] = {
// #include "data/tilesets/facility_collision.h"
};
const char TilesetBattleTowerOutsideMeta[] = "data/tilesets/battle_tower_outside_metatiles.bin.png";
const uint8_t TilesetBattleTowerOutsideColl[] = {
// #include "data/tilesets/battle_tower_outside_collision.h"
};
const char TilesetBetaWordRoomMeta[] = "data/tilesets/beta_word_room_metatiles.bin.png";
...
const char TilesetRuinsOfAlphMeta[] = "data/tilesets/ruins_of_alph_metatiles.bin.png";
...
const char TilesetHoOhWordRoomMeta[] = "data/tilesets/ho_oh_word_room_metatiles.bin.png";
const char TilesetKabutoWordRoomMeta[] = "data/tilesets/kabuto_word_room_metatiles.bin.png";
const char TilesetOmanyteWordRoomMeta[] = "data/tilesets/omanyte_word_room_metatiles.bin.png";
const char TilesetAerodactylWordRoomMeta[] = "data/tilesets/aerodactyl_word_room_metatiles.bin.png";
