...
#define checkmapscene(_map)         SCRIPT_EVCMD(Script_checkscene_Conv, MAP_ID(_map))
...
#define givepokemail(_mail)         SCRIPT_EVCMD(Script_givepokemail_Conv, _mail)
#define checkpokemail(_str)         SCRIPT_EVCMD(Script_checkpokemail_Conv, _str)
...
#define checkpoke(_s)               SCRIPT_EVCMD(Script_checkpoke_Conv, _s)
...
#define givepokeext(_s,_l,_i,_n,_o) SCRIPT_EVCMD(Script_givepoke_Conv, _s, _l, _i, true, _n, _o)
#define givepoke(_s,_l,_i)          SCRIPT_EVCMD(Script_givepokesimple_Conv, _s, _l, _i)
#define giveegg(_species, _lvl)     SCRIPT_EVCMD(Script_giveegg_Conv, _species, _lvl)
