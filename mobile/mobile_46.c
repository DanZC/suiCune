...
void Function118180(void){
    ...
    || CheckStringContainsLessThanBNextCharacters_Conv((const uint8_t*)&wram->w3_d202, 1, 0x96).flag) {
    // return_d3:
        // LD_A(0xd3);
...
void Function11ad95(void){
    ...
    // CALL(aLoadMenuHeader);
    LoadMenuHeader_Conv2(&MenuHeader_11ae38);
    // CALL(aMenuBox);
    MenuBox_Conv();
...
void Function11ae4e(void){
    ...
    // CALL(aLoadMenuHeader);
    LoadMenuHeader_Conv2(&MenuHeader_11afe8);
    // CALL(aMenuBox);
    MenuBox_Conv();
    ...
    // CALL(aLoadMenuHeader);
    LoadMenuHeader_Conv2(&MenuHeader_11b013);
    // CALL(aMenuBox);
    MenuBox_Conv();
    // hlcoord(16, 8, wTilemap);
