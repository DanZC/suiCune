...
void Function170cc6(void){
    ...
    LoadPNG2bppAssetSectionToVRAM(wram->wDecompressScratch + LEN_2BPP_TILE * 53, ElectroBallMobileGFX, 58, 5);
    LoadPNG2bppAssetSectionToVRAM(wram->wDecompressScratch + LEN_2BPP_TILE * 58, ElectroBallMobileGFX, 65, 2);
    LoadPNG2bppAssetSectionToVRAM(wram->wDecompressScratch + LEN_2BPP_TILE * 60, ElectroBallMobileGFX, 68, 1);
    LoadPNG2bppAssetSectionToVRAM(wram->wDecompressScratch + LEN_2BPP_TILE * 61, ElectroBallMobileGFX, 71, 9);
    LoadPNG2bppAssetSectionToVRAM(wram->wDecompressScratch + LEN_2BPP_TILE * 70, ElectroBallMobileGFX, 81, 3);
    LoadPNG2bppAssetSectionToVRAM(wram->wDecompressScratch + LEN_2BPP_TILE * 73, ElectroBallMobileGFX, 85, 1);
    LoadPNG2bppAssetSectionToVRAM(wram->wDecompressScratch + LEN_2BPP_TILE * 74, ElectroBallMobileGFX, 87, 8);
    // LD_DE(wBGPals1);
    // LD_HL(vTiles0);
