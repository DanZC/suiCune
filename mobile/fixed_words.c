...
void Function11c3ed(void){
    ...
    else if(hJoypadPressed & B_BUTTON) {
    // asm_11c41a:
        // CALL(aPlayClickSFX);
        PlayClickSFX_Conv();
    ...
    else if(hJoypadPressed & A_BUTTON) {
    // asm_11c42c:
        // LD_A_addr(wcd20);
        // CP_A(0x6);
