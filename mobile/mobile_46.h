...
extern const struct MenuHeader MenuData_119cff;
extern const char String_119d07[];
extern const char String_119d07_2[];
extern const char* Strings_L10ToL100[];
extern const char* Strings_Ll0ToL40[];
extern const char BattleTowerCancelString[];
...
extern const uint8_t Unknown_11a89a[];
extern const uint8_t Unknown_11a8ba[];
extern const uint8_t Unknown_11a8da[];
...
extern const txt_cmd_s Text_BattleRoomVisitLimit[];
...
extern const txt_cmd_s Text_WhichBattleRoom[];
extern const txt_cmd_s Text_ThisBattleRoomPleaseWait[];
...
extern const struct MenuHeader MenuHeader_11ae38;
extern const char String_11ae40[];
...
void asm_11afbd(const uint16_t* hl, uint8_t a);
extern const uint16_t Unknown_11afcc[];
extern const uint16_t Unknown_11afd2[];
void Function11afd6(uint8_t* hl, uint8_t b, uint8_t c);
extern const struct MenuHeader MenuHeader_11afe8;
extern const char String_11aff0[];
extern const char String_11b003[];
extern const struct MenuHeader MenuHeader_11b013;
extern const char String_11b01b[];
...
extern const char String_11b308[];
extern const char String_11b30e[];
...
extern const uint8_t TilemapPack_11ba44[];
extern const uint8_t TilemapPack_11bb7d[];
