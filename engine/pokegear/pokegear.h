...
extern const struct TextCmd PokegearAskWhoCallText[];
extern const struct TextCmd PokegearPressButtonText[];
extern const struct TextCmd PokegearAskDeleteText[];
