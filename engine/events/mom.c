...
// fallthrough
    ...
    if((!bit_test(wram->wDST, 7) && hHours == 23)    // within one hour of 23:00 outside of DST?
    || ( bit_test(wram->wDST, 7) && hHours == 0))    // within one hour of 00:00 in DST?
    {
    // LostBooklet:
