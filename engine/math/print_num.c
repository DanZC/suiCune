...
ok:
    ...
    skip2:
        ...
        // AND_A_A;
        // IF_NZ goto skip5;
        if((hPrintNumBuffer + 2) != 0) goto skip5;
...
skip6:
    // LDH_A_addr(hPrintNumBuffer + 8);
    // LDH_addr_A(hPrintNumBuffer + 2);
    (hPrintNumBuffer + 2, (hPrintNumBuffer + 8));

skip3:
    // LDH_A_addr(hPrintNumBuffer + 7);
    // LDH_addr_A(hPrintNumBuffer + 1);
    (hPrintNumBuffer + 1, (hPrintNumBuffer + 7));

skip1:
    // LDH_A_addr(hPrintNumBuffer + 0);
    // OR_A_C;
    // IF_Z goto PrintLeadingZero;
    if((*(hPrintNumBuffer + 0) | c) == 0)
    {
    //  prints a leading zero unless they are turned off in the flags
        // BIT_D(7);  // print leading zeroes?
        // RET_Z ;
    ...
    // BIT_D(5);
    // IF_Z goto done;
    if((hPrintNumBuffer + 0) == 0 && bit_test(*d, 5))
    {
        // LD_A(0xf0);
        // LD_hli_A;
        gb_write((*hl)++, 0xf0);
...
// start:
    ...
    //  seven
        // LD_A(HIGH(1000000 >> 8));
        // LDH_addr_A(hPrintNumBuffer + 4);
        (hPrintNumBuffer + 4, HIGH(1000000 >> 8));

        // LD_A(HIGH(1000000));  // mid
        // LDH_addr_A(hPrintNumBuffer + 5);
        (hPrintNumBuffer + 5, HIGH(1000000));

        // LD_A(LOW(1000000));
        // LDH_addr_A(hPrintNumBuffer + 6);
        (hPrintNumBuffer + 6, LOW(1000000));
    ...
    // six:
        // LD_A(HIGH(100000 >> 8));
        // LDH_addr_A(hPrintNumBuffer + 4);
        (hPrintNumBuffer + 4, HIGH(100000 >> 8));

        // LD_A(HIGH(100000));  // mid
        // LDH_addr_A(hPrintNumBuffer + 5);
        (hPrintNumBuffer + 5, HIGH(100000));

        // LD_A(LOW(100000));
        // LDH_addr_A(hPrintNumBuffer + 6);
        (hPrintNumBuffer + 6, LOW(100000));
    ...
    // five:
        // XOR_A_A;  // HIGH(10000 >> 8)
        // LDH_addr_A(hPrintNumBuffer + 4);
        (hPrintNumBuffer + 4, 0); // HIGH(10000 >> 8)

        // LD_A(HIGH(10000));  // mid
        // LDH_addr_A(hPrintNumBuffer + 5);
        (hPrintNumBuffer + 5, HIGH(10000));

        // LD_A(LOW(10000));
        // LDH_addr_A(hPrintNumBuffer + 6);
        (hPrintNumBuffer + 6, LOW(10000));
    ...
    // four:
        // XOR_A_A;  // HIGH(1000 >> 8)
        // LDH_addr_A(hPrintNumBuffer + 4);
        (hPrintNumBuffer + 4, 0); // HIGH(1000 >> 8)

        // LD_A(HIGH(1000));  // mid
        // LDH_addr_A(hPrintNumBuffer + 5);
        (hPrintNumBuffer + 5, HIGH(1000));

        // LD_A(LOW(1000));
        // LDH_addr_A(hPrintNumBuffer + 6);
        (hPrintNumBuffer + 5, LOW(1000));
    ...
    // three:
        // XOR_A_A;  // HIGH(100 >> 8)
        // LDH_addr_A(hPrintNumBuffer + 4);
        (hPrintNumBuffer + 4, 0); // HIGH(100 >> 8)

        // XOR_A_A;  // HIGH(100) // mid
        // LDH_addr_A(hPrintNumBuffer + 5);
        (hPrintNumBuffer + 5, 0); // HIGH(100)

        // LD_A(LOW(100));
        // LDH_addr_A(hPrintNumBuffer + 6);
        (hPrintNumBuffer + 6, LOW(100)); // HIGH(100)
...
static void v_PrintNum_PrintDigit_Conv2(uint8_t** hl, uint8_t* d, uint8_t* e)
{
    // DEC_E;
    // IF_NZ goto ok;
    (*e)--;
...
skip1:
    ...
    // BIT_D(5);
    // IF_Z goto done;
    if(hPrintNumBuffer[0] == 0 && bit_test(*d, PRINTNUM_MONEY_F))
    {
        // LD_A(0xf0);
        // LD_hli_A;
        *((*hl)++) = CHAR_MONEY_ICON;
...
//  the number is left-aligned, and no nonzero digits have been printed yet
// #define v_PrintNum_AdvancePointer() do {
//     if(!(!bit_test(d, PRINTNUM_LEADINGZEROS_F) && bit_test(d, PRINTNUM_LEFTALIGN_F) && hPrintNumBuffer[0] == 0)){
//         hl++;
//     }
// } while(0)
//     BIT_D(7);  // print leading zeroes?
...
//     RET;
    ...
    // BIT_B(7);
    // IF_NZ goto moneyflag;
    else if(bit_test(b, PRINTNUM_LEADINGZEROS_F)) 
    {
    // moneyflag:
    //   //  101xxxxx or 011xxxxx
        // LD_A(0xf0);
    ...
    // BIT_B(6);
    // IF_Z goto main;
    else if(!bit_test(b, PRINTNUM_LEFTALIGN_F)) 
    {
        // goto main
    }
...
// start:
    ...
    // three:
        ...
        // LD_A(LOW(100));
        // LDH_addr_A(hPrintNumBuffer + 6);
        hPrintNumBuffer[6] = LOW(100); // LOW(100)
