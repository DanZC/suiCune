...
extern const struct TextCmd OakTimeWokeUpText[];
extern const struct TextCmd OakTimeWhatTimeIsItText[];
// void String_oclock(void);
extern const struct TextCmd OakTimeWhatHoursText[];
extern const struct TextCmd OakTimeHowManyMinutesText[];
// void String_min(void);
extern const struct TextCmd OakTimeWhoaMinutesText[];
extern const struct TextCmd OakText_ResponseToSetTime[];
