...
// void CallInSafeGFXMode(void(*hl)(void));
void HDMATransferToWRAMBank3(uint8_t* hl);
void WaitDMATransfer(void);
// void HDMATransfer_Wait127Scanlines_toBGMap(uint16_t hl);
void HDMATransfer_Wait123Scanlines_toBGMap(uint16_t hl);
void HDMATransfer_NoDI(void);
// void HDMATransfer_Wait123Scanlines(uint16_t hl, uint16_t de, uint8_t c);
// void HDMATransfer_Wait127Scanlines(uint16_t hl, uint16_t de, uint8_t c);
void v_continue_HDMATransfer(uint16_t hl, uint16_t de, uint8_t c, uint8_t b);
void v_LoadHDMAParameters(void);
// void PadTilemapForHDMATransfer(uint8_t* hl, const uint8_t* de);
// void PadAttrmapForHDMATransfer(uint8_t* hl, const uint8_t* de);
// void PadMapForHDMATransfer(uint8_t* hl, const uint8_t* de, uint8_t c);
