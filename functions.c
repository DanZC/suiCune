...
CONVERTED(v_AnimateTileset);
    ...
    REDIRECTED(asm_48922);
    REDIRECTED(Function4873c);
    REDIRECTED(Function48a3a);
    REDIRECTED(Mie);
    ...
    REDIRECTED(Miyazaki);
    REDIRECTED(Saga);
    REDIRECTED(MenuHeader_0x484f1);
    REDIRECTED(Strings_484fb);
    REDIRECTED(Yamaguchi);
    REDIRECTED(Function48d4a);
    REDIRECTED(Fukushima);
    REDIRECTED(Function4840c);
    REDIRECTED(MobileString_OK);
    REDIRECTED(Ibaraki);
    REDIRECTED(asm_48bc7);
    REDIRECTED(Function48c0f);
    REDIRECTED(Kagawa);
    REDIRECTED(Function489ea);
    REDIRECTED(Function48272);
    REDIRECTED(MobileDownArrowGFX);
    REDIRECTED(Aomori);
    REDIRECTED(Function48725);
    REDIRECTED(Function48c8e);
    REDIRECTED(Nagasaki);
    REDIRECTED(Gifu);
    REDIRECTED(Function486bf);
    REDIRECTED(String_48a38);
    REDIRECTED(Okinawa);
    REDIRECTED(Function4880e);
    REDIRECTED(InitMobileProfile);
    REDIRECTED(Mobile12_Bin2Dec);
    REDIRECTED(Function48ab5);
    REDIRECTED(Function483bb);
    REDIRECTED(String_48aa1);
    REDIRECTED(Tochigi);
    REDIRECTED(MobileDesc_Address);
    // CONVERTED(Function48cda);
    REDIRECTED(Shimane);
    REDIRECTED(MobileDesc_Gender);
    REDIRECTED(Shizuoka);
    REDIRECTED(Function48c5a);
    REDIRECTED(Function4896e);
    REDIRECTED(Function48c0d);
    REDIRECTED(asm_48972);
    REDIRECTED(Prefectures);
    REDIRECTED(MobileString_Age);
    REDIRECTED(MenuData_0x484f9);
    REDIRECTED(Fukuoka);
    REDIRECTED(Gunma);
    REDIRECTED(Aichi);
    REDIRECTED(Function48bd7);
    REDIRECTED(Osakafu);
    REDIRECTED(Oita);
    REDIRECTED(Function48689);
    REDIRECTED(Function4820d);
    REDIRECTED(Hiroshima);
    REDIRECTED(Function4876f);
    REDIRECTED(MobileString_PersonalInfo);
    REDIRECTED(MobileString_ProfileChanged);
    REDIRECTED(MenuHeader_0x48504);
    REDIRECTED(Tokushima);
    REDIRECTED(asm_4828d);
    REDIRECTED(Function48c63);
    REDIRECTED(Function48304);
    REDIRECTED(Function48d30);
    REDIRECTED(MenuHeader_0x48a9c);
    REDIRECTED(Akita);
    REDIRECTED(Function48187);
    REDIRECTED(Function48d3d);
    REDIRECTED(Function48c00);
    REDIRECTED(Function48c11);
    REDIRECTED(Fukui);
    REDIRECTED(MobileDesc_Age);
    REDIRECTED(Function48d94);
    REDIRECTED(MenuHeader_0x48513);
    REDIRECTED(MobileString_ZipCode);
    REDIRECTED(Tottori);
    // CONVERTED(MobileProfileString);
    REDIRECTED(Function48283);
    REDIRECTED(Function487ec);
    REDIRECTED(Kanagawa);
    REDIRECTED(MobileUpArrowGFX);
    REDIRECTED(String_484ff);
    REDIRECTED(Kumamoto);
    REDIRECTED(Kagoshima);
    REDIRECTED(Ishikawa);
    REDIRECTED(Chiba);
    REDIRECTED(String_4880d);
    REDIRECTED(Kochi);
    REDIRECTED(Kyotofu);
    REDIRECTED(Function48383);
    REDIRECTED(Saitama);
    REDIRECTED(Yamanashi);
    REDIRECTED(Function488b9);
    REDIRECTED(String_484fb);
    REDIRECTED(Iwate);
    REDIRECTED(Function48c4d);
    REDIRECTED(Niigata);
    REDIRECTED(MenuHeader_0x48509);
    REDIRECTED(MenuData_0x4851b);
    REDIRECTED(Function48a9a);
    REDIRECTED(Nagano);
    // CONVERTED(Function48cfd);
    REDIRECTED(Function488b4);
    REDIRECTED(Wakayama);
    REDIRECTED(MenuHeader_0x4850e);
    REDIRECTED(Function48ca3);
    REDIRECTED(MobileDesc_ZipCode);
    REDIRECTED(MobileString_Address);
    REDIRECTED(Function483e8);
}
